...
This package is contains convenience functions to make some common tasks with string manipulation and regular expressions a bit easier.
...
You can install the development version of regexcitefa2 from [GitHub](https://github.com/) with:
